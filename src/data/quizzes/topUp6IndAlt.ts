...
export const topUp6IndAlt: { lessonId: string; questions: QuizQuestion[] }[] = [
  {
    ...
    questions: [
      { id: "indicators-1-tu1", question: "If a country's GDP grew 4% nominally while inflation ran 4%, its real GDP growth was about…", options: ["About 8 percent, adding the two figures", "0 percent - the gain was purely prices", "4 percent, regardless of the inflation rate", "Negative 4 percent after the adjustment"], correctAnswer: 1, explanation: "Real GDP strips out inflation, so 4% nominal minus 4% inflation leaves zero true growth." },
      ...
      { id: "indicators-1-tu4", question: "A mature economy suddenly posting 15% annual real GDP growth would most likely signal…", options: ["Overheating or unusual catch-up, not normal cruising speed", "A perfectly healthy, sustainable long-run pace", "A measurement that wrongly removed inflation twice", "That the country completely stopped consumer spending"], correctAnswer: 0, explanation: "Mature economies typically cruise at 2-3% real growth, so numbers far above that usually signal overheating or catch-up." }
    ]
  },
  {
    lessonId: "indicators-2",
    questions: [
      { id: "indicators-2-tu1", question: "A retiree who is not looking for work is counted in the unemployment rate as…", options: ["Unemployed, just like anyone else jobless", "Not counted unless you are actively job-hunting", "Employed in the statistics by default", "Double-counted in the figures for accuracy"], correctAnswer: 1, explanation: "The headline rate only counts people who are jobless AND actively searching, so retirees are excluded." },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "alt-3-tu2", question: "A key difference between a bar of gold and a share of stock is that gold…", options: ["Pays out a detailed quarterly profit report", "Sends you interest payments twice a year", "Produces no earnings, so returns come from price", "Grants shareholders voting rights at working farms"], correctAnswer: 2, explanation: "Gold never innovates or pays you, so you profit only if someone later pays more for it." },
  ...
  },
  {
    lessonId: "alt-6",
    questions: [
      { id: "alt-6-tu1", question: "Why is holding your emergency fund in collectibles or NFTs a bad idea?", options: ["Collectibles are guaranteed to lose their value", "Emergencies need cash fast, but those sell slowly", "The federal government bans owning any collectibles", "They always sell instantly at their full price"], correctAnswer: 1, explanation: "Emergencies demand quick cash, illiquid items like NFTs or collectibles can take weeks and a discount to sell." },
