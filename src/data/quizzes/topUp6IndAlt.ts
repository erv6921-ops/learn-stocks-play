...
export const topUp6IndAlt: { lessonId: string; questions: QuizQuestion[] }[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "alt-2-tu3", question: "Rising interest rates often pressure REIT prices because…", options: ["The buildings physically shrink", "Raising rent becomes illegal", "Dividends automatically stop", "Costlier debt and higher rival bond yields both squeeze them"], correctAnswer: 3, explanation: "Property empires run on debt, and when safe bonds pay more, REIT yields must compete, squeezing prices." },
  ...
  },
  {
    lessonId: "alt-4",
    questions: [
      { id: "alt-4-tu1", question: "A blockchain is essentially…", options: ["A private company's internal database", "A public ledger that no single party controls", "A type of computer virus", "A government money printer"], correctAnswer: 1, explanation: "A blockchain records transactions across thousands of computers at once, the innovation underneath every cryptocurrency." },
  ...
  },
  {
    lessonId: "alt-6",
    questions: [
      { id: "alt-6-tu1", question: "Liquidity measures how quickly an asset can be…", options: ["Melted into physical form", "Sold at a fair price when you need the cash", "Insured by the government", "Duplicated for resale"], correctAnswer: 1, explanation: "Cash is perfectly liquid, while a house or rare card may take months to sell without slashing the price." },
