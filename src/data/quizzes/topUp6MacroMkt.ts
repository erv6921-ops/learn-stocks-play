...
export const topUp6MacroMkt: { lessonId: string; questions: QuizQuestion[] }[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "macro-4-tu2", question: "When short-term rates are already near zero, the Fed can still inject money by…", options: ["Mailing checks to every household", "Buying bonds to push down long-term rates (QE)", "Raising taxes on the wealthy", "Minting a trillion-dollar coin"], correctAnswer: 1, explanation: "Quantitative easing purchases bonds to suppress long-term borrowing costs, as in 2008 and 2020." },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "macro-5-tu4", question: "A teen saving for a car in a high-rate period should remember that…", options: ["Savings earn more, but the car loan costs more too", "Neither savings nor loans are affected", "The bank gives cars away", "Only mortgages change price"], correctAnswer: 0, explanation: "Rates cut both ways, so factor in both the faster-growing fund and the pricier financing." },
    ],
  },
  {
    lessonId: "macro-6",
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "macro-7-tu3", question: "2022 was historically brutal for bonds because…", options: ["Rates rose from near 0% to 4%+ at a historic pace", "Bonds were briefly outlawed", "Every issuer defaulted at once", "Investors forgot bonds existed"], correctAnswer: 0, explanation: "The Fed's rapid rate sprint crushed existing bond prices in the safe asset's worst modern year." },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "market-6-tu4", question: "Companies often release earnings at 4:05pm rather than mid-session because it…", options: ["Gives the market overnight to digest the news", "Lets night-shift printers run", "Hides bad results from everyone", "Costs less at the exchange"], correctAnswer: 0, explanation: "Releasing after the close avoids triggering mid-session chaos and lets investors process the news." },
    ],
  },
  {
    lessonId: "market-7",
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "market-9-tu4", question: "The SEC's core mission is to…", options: ["Guarantee every investor a profit", "Set the daily price of each stock", "Collect taxes on trading gains", "Protect investors and keep markets fair and orderly"], correctAnswer: 3, explanation: "The SEC protects investors and maintains fair markets, not profit promises." },
    ],
  },
  {
    lessonId: "market-10",
