...
export const investingStocksCoreQuizzes: LessonQuiz[] = [
  ...
  // ── INVEST-3: Simple vs Compound ──
  {
    ...
    questions: [
      ...
      { id: "invest-3-q4", question: "The Rule of 72 estimates…", options: ["Years for money to double at a rate", "The single ideal retirement age for savers", "The maximum safe withdrawals allowed per year", "How many stocks a good portfolio needs"], correctAnswer: 0, explanation: "72 ÷ rate ≈ doubling time. At 8%, money doubles roughly every 9 years." },
