...
export const marketsRatiosValuationQuizzes: LessonQuiz[] = [
  ...
  // ── MARKET-7: Circuit Breakers ──
  {
    ...
    questions: [
      ...
      { id: "market-7-q5", question: "Single stocks also have their own version, called…", options: ["Limit up / limit down halts", "Personal trading timeout penalties for the investor", "Automatic dividend suspension and freeze rules", "Weekend-only restricted stock trading bans"], correctAnswer: 0, explanation: "Individual stocks pause briefly when they move too far too fast - the same cooling-off logic, stock by stock." },
  ...
  // ── VALUATION-4: Market Expectations ──
  {
    ...
    questions: [
      ...
      { id: "valuation-4-q6", question: "Low expectations can be an ally because…", options: ["Modest good news can rerate a written-off stock", "Nothing can disappoint the market any further", "Cheap stocks are legally required to recover", "Deep pessimism naturally attracts government subsidies"], correctAnswer: 0, explanation: "When the market prices in disaster, 'less bad than feared' becomes a catalyst - expectations set the hurdle height." },
    ],
  },
  // ── VALUATION-5: Simplified DCF ──
  {
    ...
    questions: [
      ...
      { id: "valuation-5-q5", question: "If your conservative DCF says $80 and the stock trades at $50, the stock may be…", options: ["Undervalued - with a margin of safety", "Overvalued - you should sell immediately", "Fairly priced almost to perfection", "Impossible to analyze any further"], correctAnswer: 0, explanation: "Buying below conservative estimates builds in room for error - the margin-of-safety principle." },
  ...
  // ── VALUATION-6: Intrinsic vs Market ──
  {
    ...
    questions: [
      ...
      { id: "valuation-6-q2", question: "Ben Graham's 'Mr. Market' parable teaches that market prices are…", options: ["Offers from a moody partner to ignore", "Always perfectly rational and completely correct", "Set by government officials every single day", "Fixed and unchangeable by federal law"], correctAnswer: 0, explanation: "Mr. Market shows up manic or depressed with daily offers - you're free to take advantage or ignore him entirely." },
