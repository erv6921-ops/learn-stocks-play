...
export const topUp6StkSim: { lessonId: string; questions: QuizQuestion[] }[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "stocks-6-tu4", question: "Over many years, the main driver of a stock's price is…", options: ["Daily ups and downs in investor sentiment", "The news headlines each and every morning", "Government scheduling and its calendar decisions", "The company's business results and earnings growth"], correctAnswer: 3, explanation: "Short-term moves are mood and news, but over years earnings growth does the heavy lifting." },
    ],
  },
  {
    lessonId: "stocks-8",
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "sim-1-tu3", question: "Continuing scheduled investing during a bear market lets you…", options: ["Directly violate your broker's trading account rules", "Guarantee yourself further steep investment losses", "Buy more shares per dollar at low prices", "Predict the exact market bottom every time"], correctAnswer: 2, explanation: "Bear markets are accumulation season, and shares bought in the gloom drive outsized gains in the recovery." },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "sim-3-tu4", question: "Rising interest rates traditionally hit which sector hardest?", options: ["Deep-discount grocery and retail chains", "Regulated electric utility monopolies", "Banks that earn a lending spread", "Growth tech valued on far-future profits"], correctAnswer: 3, explanation: "Distant earnings discount hardest when rates climb, which is why growth tech gets hammered." },
    ],
  },
  {
    lessonId: "sim-4",
    questions: [
      { id: "sim-4-tu1", question: "When shocking news hits markets, the first smart move is to…", options: ["Pause and make no decisions inside the panic", "Sell absolutely everything within a few minutes", "Borrow money to trade the wild swings", "Refresh the prices every ten seconds"], correctAnswer: 0, explanation: "The worst trades are made in the first hours of fear, so a deliberate delay is a professional discipline." },
  ...
  },
  {
    lessonId: "sim-6",
    questions: [
      { id: "sim-6-tu1", question: "The core idea of a balanced portfolio is that…", options: ["No single failure can wreck the plan", "Every single holding moves in identical lockstep", "The portfolio's returns are fully guaranteed", "Only guaranteed winners are ever owned"], correctAnswer: 0, explanation: "Blending stocks, bonds, and cash weights risk against goals and is built to survive surprises." },
