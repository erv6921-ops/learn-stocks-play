...
export const topUp6StkSim: { lessonId: string; questions: QuizQuestion[] }[] = [
  ...
  },
  {
    lessonId: "stocks-9",
    questions: [
      { id: "stocks-9-tu1", question: "The VIX index is nicknamed the…", options: ["Profit meter", "Fear gauge", "Dividend calendar", "Trader blacklist"], correctAnswer: 1, explanation: "The VIX tracks expected S&P 500 volatility and spikes when investors brace for turbulence." },
      ...
      { id: "stocks-9-tu3", question: "The biggest danger volatility poses to ordinary investors is…", options: ["Brokers closing during big moves", "The swings themselves removing money", "Panic-selling at the bottom of a swing", "Prices freezing permanently"], correctAnswer: 2, explanation: "Paper losses become real only when you sell, so volatility's main casualty is investor behavior." },
  ...
  },
  {
    lessonId: "sim-3",
    questions: [
      { id: "sim-3-tu1", question: "Sector rotation is the strategy of…", options: ["Buying every sector equally forever", "Chasing the cycle's currently favored sectors", "Trading one stock repeatedly", "Avoiding all sector funds"], correctAnswer: 1, explanation: "Rotation shifts money toward the cycle's leaders, such as banks in early recovery and utilities in downturns." },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "sim-4-tu4", question: "The single best predictor of surviving a market crisis is…", options: ["Your behavior, not your stock picks", "The exact funds you owned", "Your broker's app design", "Pure luck"], correctAnswer: 0, explanation: "Ordinary portfolios held with discipline beat brilliant portfolios abandoned in fear, so temperament is the edge." },
    ],
  },
  {
    lessonId: "sim-5",
    questions: [
      ...
      { id: "sim-5-tu2", question: "'Sequence of returns risk' means retirees are hurt most by…", options: ["Bad market years early in retirement", "Any volatility after age 80", "Steady returns of any size", "Markets rising too fast"], correctAnswer: 0, explanation: "Withdrawing during early crashes digs a hole the portfolio may never escape, so WHEN returns arrive matters." },
