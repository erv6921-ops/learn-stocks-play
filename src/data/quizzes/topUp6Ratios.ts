...
export const topUp6Ratios: { lessonId: string; questions: QuizQuestion[] }[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "ratios-7-tu3", question: "A stock trades at P/E 30 but has averaged 20 for a decade. This mainly tells you…", options: ["It is richly valued versus its own history", "Its exact share price early next year", "That the CEO is personally very confident", "Absolutely nothing useful to a real investor"], correctAnswer: 0, explanation: "Comparing a multiple to its own history flags whether it's cheap or rich versus the past." },
