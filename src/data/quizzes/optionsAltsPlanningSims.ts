...
export const optionsAltsPlanningSimsQuizzes: LessonQuiz[] = [
  ...
  // ── OPTIONS-2: Strike Price ──
  {
    ...
    questions: [
      ...
      { id: "options-2-q3", question: "An 'out of the money' option still costs a premium because…", options: ["There's still time for the stock to move", "Regulators require minimum prices", "It pays dividends meanwhile", "Premiums are refundable later"], correctAnswer: 0, explanation: "Time value: the CHANCE of finishing in-the-money before expiry is worth something - and decays daily." },
      { id: "options-2-q4", question: "Choosing a far out-of-the-money strike makes the option…", options: ["Cheaper but much less likely to pay off", "More expensive and safer", "Free of any expiration date", "Identical to owning the stock"], correctAnswer: 0, explanation: "Lottery-ticket economics: tiny premium, long odds - most expire worthless." },
  ...
  // ── OPTIONS-3: Expiration ──
  {
    ...
    questions: [
      ...
      { id: "options-3-q3", question: "Being RIGHT about direction but WRONG about timing means an option buyer…", options: ["Can still lose everything on that trade", "Always profits eventually", "Gets the premium refunded", "Receives extra time automatically"], correctAnswer: 0, explanation: "The stock rising a month AFTER expiration pays you nothing - options demand being right on schedule." },
  ...
  // ── ALT-3: Commodities ──
  {
    ...
    questions: [
      ...
      { id: "alt-3-q2", question: "Unlike stocks, commodities generate…", options: ["No earnings - returns are price only", "Quarterly profit reports", "Interest payments twice yearly", "Voting rights at farms"], correctAnswer: 0, explanation: "A bar of gold never innovates or pays you - you profit only if someone later pays more for it." },
  ...
  // ── PLAN-5: Lifestyle Planning ──
  {
    lessonId: "plan-5",
    questions: [
      { id: "plan-5-q1", question: "Lifestyle planning starts by asking…", options: ["What life do I want money to build?", "What car impresses people most?", "How much do influencers earn?", "Which stocks are trending today?"], correctAnswer: 0, explanation: "Money is the tool, not the goal - travel, family, freedom, craft: the vision determines every financial number beneath it." },
      ...
      { id: "plan-5-q3", question: "The antidote to lifestyle creep is…", options: ["Auto-saving a fixed share of every raise first", "Refusing all promotions", "Upgrading immediately upon each raise", "Hiding income from yourself"], correctAnswer: 0, explanation: "Bank half of each raise before touching it - lifestyle still improves while wealth compounds in the background." },
