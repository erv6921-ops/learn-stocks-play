  ...
  // ═══════════════════════════════════════════════
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          "Nothing, because the market always recovers within a week",
          "He earns extra dividends that offset the entire loss",
          "The bank freezes his account until the market recovers",
          "His fund is now worth about $5,400, forcing him to sell low right when he needs cash"
        ],
        correctAnswer: 3,
      ...
      },
      {
        ...
        options: [
          "Annual car registration renewal that arrives every March",
          "Holiday gifts you buy every December",
          "A sudden $1,200 furnace failure in the middle of winter",
          "A yearly insurance premium billed each January"
        ],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: [
          "Because freelancers legally must hold larger funds",
          "Because a bigger fund earns a higher interest rate automatically",
          "Because income gaps are more likely and can last longer without a steady paycheck",
    ...
    questions: [
      {
        ...
        options: [
          "To buy fun things when they go on sale",
          "To cover unexpected costs like a job loss or sudden repair",
          "To pay for a planned vacation next summer",
          "To grow rich quickly by taking big risks"
        ],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: [
          "So you can spend it on treats anytime",
          "Because emergencies happen fast and you may need the money quickly",
          "So the bank can charge you more fees",
          "So friends can borrow it easily"
        ],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: [
          "The full $6,000, because a raise is always extra money",
          "$0, because her $6,600 of new yearly spending exceeds the raise",
          "$3,000, because she only spends half",
          "$600, because only the car counts against it"
        ],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: [
          "$120, cutting only the music service",
          "$840, cutting everything on the list",
          "$132, cutting only the streaming service",
      ...
      },
      {
        ...
        options: [
          "Buy it because saving $48 is a guaranteed win",
          "Skip it, because 40% off something unneeded still wastes the $72 he would spend",
          "Buy two so the per-item savings are even larger",
          "Buy it since sale items never count against a budget"
        ],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: [
          "No, because the buffer is only $20",
          "No, because buffers cannot be used for gifts",
          "Yes, but only if she cancels rent",
      ...
      },
      {
        ...
        options: [
          "Because raises only help people who spend them",
          "Because he avoided lifestyle inflation, so the raise built savings instead of higher bills",
          "Because Cole earned a lower salary the whole time",
          "Because investing is not allowed after a raise for Cole"
        ],
        correctAnswer: 1,
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          "Instantly upgrade your car and apartment",
          "Spend all of it on treats",
      ...
      },
      {
        ...
        options: [
          "How many can I buy?",
          "Can I get it even cheaper next week?",
          "Which color looks best?",
          "Would I buy this at full price and do I need it?"
        ],
        correctAnswer: 3,
    ...
    questions: [
      {
        ...
        options: [
          "Lea, because handwriting is always more accurate",
          "Neither, because both methods require linking a bank",
          "Lea, because apps cannot categorize spending",
      ...
      },
      {
        ...
        options: [
          "Borrow freely from any envelope since it all evens out",
          "Stop gas spending or consciously move cash from Groceries, keeping the total fixed",
          "Use a credit card because envelopes do not apply to gas",
          "Refill both envelopes with new money from savings"
        ],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: [
          "A bank-syncing app, because it is the most automated",
          "A social budgeting app that shares data publicly",
          "A custom spreadsheet, because it needs no bank link and allows total customization",
          "Whatever tool their friends use most"
        ],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: [
          "Yes, because you must only ever use one tool",
          "Yes, because more tools always means worse budgeting",
          "No, but only because it costs more money",
          "No, because different tools serve different purposes and she uses each for its strength"
        ],
        correctAnswer: 3,
      ...
      },
      {
        ...
        options: [
          "The app, because prettier tools are always better",
          "The notebook, because the best tool is the one you consistently use",
          "Neither, because only expensive tools work",
          "The app, because notebooks cannot track money"
        ],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: [
          "Doing mental math and reading text-only statements",
          "The cash envelope method and an app with charts and progress bars",
          "Memorizing totals and avoiding all tools",
          "Only reading printed bank statements"
        ],
        correctAnswer: 1,
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          "It links to every bank by law",
          "It gives more control and does not require sharing bank data",
          "It automatically fills itself in",
          "It is the only allowed budgeting tool"
        ],
        correctAnswer: 1,
  ...
  // ═══════════════════════════════════════════════
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          "$0, because it always empties out",
          "$100, because $3,200 plus $900 minus $4,000 is $100",
          "$1,300, because only the high month counts",
      ...
      },
      {
        ...
        options: [
          "So the bank gives them a better interest rate",
          "So they can spend the entire high month freely",
          "Because fixed bills shrink automatically when income drops",
          "So even in the worst month there is room left for food and transport"
        ],
        correctAnswer: 3,
      ...
      },
      {
        ...
        options: [
          "Leave it unassigned as leftover",
          "Spend it immediately on wants",
          "Assign it a job, such as savings or debt, so every dollar has a purpose",
      ...
      },
      {
        ...
        options: [
          "Because they pay far more in taxes than salaried workers",
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          "Upgrade your lifestyle permanently",
          "Give it all away"
        ],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: [
          "The $200 sits in cash and never changes",
          "Budgeting automatically raises her salary",
          "Investing removes the need to budget at all",
          "Invested consistently, the money earns returns that themselves earn returns over time"
        ],
        correctAnswer: 3,
      ...
      },
      {
        ...
        options: [
          ...
          "That interest does not affect long-term savings",
      ...
      },
      {
        ...
        options: [
          ...
          "That $600 a year compounds over a career into tens of thousands of extra dollars",
          "It only helps people who already have millions",
      ...
      },
      {
        ...
        options: [
          ...
          "Winning large one-time windfalls",
          "Consistently spending less than they earned and budgeting for decades",
          "Borrowing heavily to look wealthy"
        ],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: [
          "It does not, because budgets only affect the present",
          "Money you save and invest today becomes security and choices for the same person later",
          "Your future self must start over from zero",
          "Only spending, never saving, affects the future"
        ],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: [
          "It raises your paycheck by itself",
      ...
      },
      {
        ...
        options: [
          "No, small amounts never matter",
          "Yes, saving a little each month can grow large over decades",
          "Only if you are already a millionaire",
          "Only for one month at a time"
        ],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: [
          ...
          "Your future self should figure it out alone",
          "Saving only affects today"
        ],
        correctAnswer: 1,
