    ...
    sections: [
      ...
      },
      {
        ...
        questions: [
          ...
          q("apm-1-5-q2", "How does economic profit differ from accounting profit?",
            ["Economic profit subtracts implicit (opportunity) costs that accounting profit ignores", "Economic profit is always larger than accounting profit", "Accounting profit subtracts opportunity costs while economic profit does not", "They are two names for the exact same number", "Economic profit counts only revenue and no costs"], 0,
            "Accounting profit = revenue - explicit costs. Economic profit goes further and also subtracts implicit costs (the opportunity cost of the owner's own resources), so economic profit is usually SMALLER than accounting profit, not larger."),
