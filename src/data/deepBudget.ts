    ...
    sections: [
      {
        ...
        paragraphs: [
          "You met the idea of giving every dollar a job in the balanced-budget lesson. Zero-based budgeting takes that to its logical extreme and adds one distinctive twist: you rebuild the whole plan from scratch every period instead of reusing last month's. You assign every single dollar of income a job until you have zero left unassigned - and 'zero' doesn't mean you spend everything, because saving is a job too. It means income minus all your assignments equals exactly zero, with no dollars floating around undirected. The start-from-scratch discipline forces total intentionality: no money slips through the cracks because you've consciously told each dollar where to go before the month begins.",
